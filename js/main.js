...
(() => {
  ...
  (function () {
    // Quotes carry EN, TH and RU; a missing language falls back to EN.
    var testimonials = [
      {
        ...
        quote_ru: 'Мы теряли записи каждый раз, когда телефон звонил посреди стрижки. Rejig сделали нам AI-ресепшн, который отвечает на тайском, английском и русском, сразу записывает клиента и никого не держит на линии. Теперь всё работает само, а расписание заполняется во всех наших филиалах.',
        role_ru: 'Ella N. | Владелица, Ducky Cutz Barbershop, Пхукет'
      },
      {
        ...
        quote_ru: 'Rejig не просто консультировали, они построили весь механизм, с которым мы выходим на рынок: таргетинг, цепочки касаний, дизайн-систему, всё целиком. За несколько недель мы прошли путь от презентации до работающей воронки. Техническую часть они берут на себя, а мы сосредоточены на продажах.',
        role_ru: 'Denis K. | Основатель, BoBe'
      },
      {
        ...
        quote_ru: 'Нам нужна была вся операционная часть мероприятия: сайт, регистрация, спонсоры и печать, на трёх языках. Rejig Labs сделали каждую часть и работали как команда в разы больше. Они стали настоящим партнёром, и их имя стоит на баннере турнира рядом со спонсорами.',
        role_ru: 'Samran Sinthong | Вице-президент и основатель, ANRCF'
      },
      {
        ...
        quote_ru: 'Мы устанавливаем и обслуживаем лифты, мы не маркетологи. Rejig пересобрали наш сайт, сделали так, что нас находят и в поиске, и в AI-поиске, настроили CRM и перестроили путь заявок внутри бизнеса. Впервые наше присутствие в интернете соответствует качеству нашей работы на объектах.',
        role_ru: 'Suchart | Основатель, Mobile Engineer, Пхукет'
      }
    ];
    ...
    // Pick the quote/role in the active language, else English.
    function tstText(t, field) {
      var lang = (window.__i18n && window.__i18n.getLang) ? window.__i18n.getLang() : 'en';
      return (lang !== 'en' && t[field + '_' + lang]) ? t[field + '_' + lang] : t[field];
    }
