...
(function () {
  ...
  var T = {
    en: {
      bubble: 'Ask Jasmin', role: 'Rejig Labs · AI front desk', placeholder: 'Type a message', placeholderRT: 'Reply to Rut',
      gateTitle: 'Hi, I\'m <em>Jasmin</em>.',
      ...
      greetNamed: 'Hi {name}. I\'m Jasmin, Rejig\'s AI front desk. Ask me anything, or pick one:',
      greetAnon: 'Hi, I\'m Jasmin, Rejig\'s AI front desk. Ask me anything, or pick one:',
    ...
    th: {
      bubble: 'คุยกับจัสมิน', role: 'Rejig Labs · ผู้ช่วยหน้าร้าน AI', placeholder: 'พิมพ์ข้อความ', placeholderRT: 'ตอบรุจ',
      gateTitle: 'สวัสดีค่ะ <em>จัสมิน</em>ค่ะ',
      ...
      greetNamed: 'สวัสดีค่ะคุณ{name} จัสมินค่ะ ผู้ช่วยหน้าร้าน AI ของ Rejig Labs ถามได้ทุกอย่างเลยค่ะ หรือเลือกจากนี้ก็ได้',
      greetAnon: 'สวัสดีค่ะ จัสมินค่ะ ผู้ช่วยหน้าร้าน AI ของ Rejig Labs ถามได้ทุกอย่างเลยค่ะ หรือเลือกจากนี้ก็ได้',
